...
import 'sport_swim_model.dart';
export 'sport_swim_model.dart';

class SportSwimWidget extends StatefulWidget {
  const SportSwimWidget({Key? key}) : super(key: key);

  @override
  _SportSwimWidgetState createState() => _SportSwimWidgetState();
}

class _SportSwimWidgetState extends State<SportSwimWidget> {
  late SportSwimModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SportSwimModel());
