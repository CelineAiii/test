...
import 'sport_ball_model.dart';
export 'sport_ball_model.dart';

class SportBallWidget extends StatefulWidget {
  const SportBallWidget({Key? key}) : super(key: key);

  @override
  _SportBallWidgetState createState() => _SportBallWidgetState();
}

class _SportBallWidgetState extends State<SportBallWidget> {
  late SportBallModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SportBallModel());
